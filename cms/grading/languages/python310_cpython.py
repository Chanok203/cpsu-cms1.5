...
__all__ = ["Python310CPython"]


class Python310CPython(CompiledLanguage):
    """This defines the Python programming language, version 3 (more
    precisely, the subversion of Python 3.10 available on the system)
    ...
    def get_compilation_commands(self,
        ...
        commands.append(["/usr/bin/sed -i -e '1iimport sys'", source_filenames[0]])
        commands.append(["/usr/bin/sed -i -e '2iinput = lambda x: sys.stdin.readline().rstrip()'", source_filenames[0]])
